...
**6b. UPDATE (2026-08-06): CFB's dashboard label was renamed from "Power Rating" to "Power Score" as part of Phase 1 terminology unification — both models now use the same term.** Blog posts 1-3 never named either term directly, so no blog edits were needed.
...
- **CFB dashboard's glossary**: covers every model-specific term used in the CFB dashboard and in blog post-1 (Power Score, Success Rate, Explosiveness, Havoc Rate, Run/Pass Game, Coaching Continuity, Model Edge, Home Field Edge, SP+) — thorough and consistent. Left alone. (Term renamed from "Power Rating" to "Power Score" 2026-08-06.)
